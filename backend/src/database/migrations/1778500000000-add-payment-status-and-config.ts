...
export class AddPaymentStatusAndConfig1778500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const configValues = [
      { key: 'pricing.weeks_per_month', value: '4', description: 'Average weeks per month for pricing calculations' },
      { key: 'pricing.per_pickup_price', value: '500', description: 'Price per individual pickup' },
      { key: 'pricing.subscription_pickups_per_week', value: '3', description: 'Number of pickups included per week in subscription' },
      { key: 'pricing.standard_plan_price', value: '5000', description: 'Monthly price for standard subscription plan' },
      { key: 'pricing.premium_plan_price', value: '10000', description: 'Monthly price for premium subscription plan' },
    ];
